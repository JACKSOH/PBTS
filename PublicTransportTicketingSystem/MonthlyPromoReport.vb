...
Public Class MonthlyPromoReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PublicTransportTicketingSystem.MonthlyPromoReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedMonthlyPromoReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As MonthlyPromoReport = New MonthlyPromoReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
