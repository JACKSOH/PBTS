    ...
    Private Sub DataBind()
        Try
            ...
            Dim query = From promoteSchedule In db.promoteSchedules
                        ...
                        Select schedule.scheduleID, schedule.departureDateTime, schedule.estimateHours, schedule.transportID
            ...
            dgvPromotionList.Columns("estimateHours").HeaderText = "Estimate Hours"
